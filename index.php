...
<form action="filtered_results.php" class="neighbourhood" method="post">
...
<form action="sorted_results.php" class="store" method="post">
        <label>Sort store name:</label>
        <select name="order">
        	<option value="alpha">Alphabetically</option>
        	<option value="anti-alpha">Anti-alphabetically</option>
		</select>
<button type="submit" class="input,textarea">Go</button>
</form>
<table>
	<tr>
		<th>Neighbourhood</th>
